...
let CommandStar = class CommandStar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.globalState.searchState = new searchState_1.SearchState(searchState_1.SearchDirection.Forward, vimState.cursorPosition, currentWord);
            do {
...
let CommandHash = class CommandHash extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.globalState.searchState = new searchState_1.SearchState(searchState_1.SearchDirection.Backward, vimState.cursorPosition, currentWord);
            do {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.recordedState.transformations.push({
                ...
                diff: new position_1.PositionDiff(-1, 0),
            });
            return vimState;
        });
    }
...
let MoveEasyMotion = class MoveEasyMotion extends BaseMovement {
    constructor() {
        super(...arguments);
...
var PutCommand_1, MoveRepeatReversed_1, ActionVisualReflowParagraph_1, ToggleCaseOperator_1;
